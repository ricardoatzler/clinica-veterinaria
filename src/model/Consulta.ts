...
export class Consulta {
  ...
  constructor(
    ...
    this._status = StatusConsulta.AGENDADA;
    this._pago = false;
  }
  ...
  get formaPagamento(): FormaPagamento | undefined {
  ...
  cancelar(motivo: string): void {
    this._status = StatusConsulta.CANCELADA;
    this._motivoCancelamento = motivo;
  }

  finalizar(): void {
    this._status = StatusConsulta.FINALIZADA;
  }
